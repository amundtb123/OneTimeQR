  ...
  en: {
    translation: {
      ...
      upload: {
        ...
        addFiles: 'Add file(s)',
        fileTypes: 'Images, PDF, documents',
        ...
        standardModeDesc: 'One QR code – quick and easy',
        standardModeNote: 'File deleted after time or views',
        singleQrMode: 'Single QR Unlock',
        singleQrModeDesc: 'One QR code – scan to unlock',
        singleQrModeNote: 'Scan QR code to decrypt content locally',
        ...
        secureModeDesc: 'Two QR codes – extra security',
        ...
        trustlessSharing: 'Share without trust',
        trustlessSharingDesc: 'No one can read the content. Not even OneTimeQR.',
        builtForOnce: 'Built for one time',
        builtForOnceDesc: 'The file lives only as long as you decide.',
        qrGivesControl: 'QR gives control',
        qrGivesControlDesc: 'Access requires physical action – not forwarding.',
        coinCost: 'Coin cost',
        free: 'Free',
  ...
  no: {
    translation: {
      ...
      upload: {
        ...
        scanExpiryNote: 'Innholdet utløper uansett etter 7 dager. Sett antall scanninger under "Avanserte innstillinger".',
        securityTitle: 'Velg sikkerhetsnivå',
        ...
        singleQrMode: 'Single QR Unlock',
        singleQrModeDesc: 'Én QR-kode – skann for å låse opp',
        singleQrModeNote: 'Skann QR-koden for å dekryptere innhold lokalt',
        ...
        secureMode: 'Secure Mode',
        secureModeDesc: 'To QR-koder – ekstra sikkerhet',
        secureModeNote: 'Mottaker må skanne QR #2 for å åpne filen',
        secureModeInfo: '<strong>Ekstra sikkerhet:</strong> QR #1 gir tilgang, QR #2 låser opp innholdet. Begge må skannes for å se filen.',
        ...
        maxScansNote: 'La stå tom for ubegrenset',
        maxDownloads: 'Maks nedlastinger',
        maxDownloadsNote: 'La stå tom for ubegrenset',
        viewOnly: 'Kun visning',
        viewOnlyNote: 'Blokkerer nedlasting og long-press',
        noPreview: 'Forhåndsvisning ikke tilgjengelig',
        ...
        trustlessSharing: 'Del uten tillit',
        trustlessSharingDesc: 'Ingen kan lese innholdet. Ikke engang OneTimeQR.',
        builtForOnce: 'Bygget for én gang',
        builtForOnceDesc: 'Filen lever kun så lenge du bestemmer.',
        qrGivesControl: 'QR gir kontroll',
        qrGivesControlDesc: 'Tilgang krever fysisk handling – ikke videresending.',
