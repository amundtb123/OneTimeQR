  ...
  en: {
    translation: {
      ...
      qrDetail: {
        ...
        unlockCode: 'Unlock code',
        keyToUnlock: 'Key to unlock',
        downloadQr2Immediately: '⚠️ Download QR #2 immediately!',
  ...
  no: {
    translation: {
      ...
      qrDetail: {
        ...
        unlockCode: 'Opplåsingskode',
        keyToUnlock: 'Nøkkel for å låse opp',
        downloadQr2Immediately: '⚠️ Last ned QR #2 umiddelbart!',
        qr2CannotBeShownAgain: 'QR #2 kan ikke vises igjen etter at siden er oppdatert. Last ned begge QR-kodene nå.',
        shareQr1First: '💡 Del QR #1 først, deretter QR #2 via en annen kanal for ekstra sikkerhet',
